create or replace function http_user_login(http_req_text text) returns JSON as
$$
 ...
 if(!plv8.ufn){
  ...
  wf.payload.yodlee_action.url = project.yodlee_url + '/user/login';
  wf.payload.yodlee_action.code = 'login';
