create or replace function http_cobrand_login(http_req_text text) returns JSON as
$$
 ...
 if(!plv8.ufn){
  ...
  wf.payload.yodlee_action.url = project.yodlee_url + '/cobrand/login';
  wf.payload.yodlee_action.code = 'coblogin';
